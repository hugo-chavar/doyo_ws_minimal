defmodule OrderSerializer.DataMapper do
  ...
  def map_order(order_data) when is_map(order_data) do
    %Order{
      ...
      total: (order_data["total"] || 0.0) |> Float.round(2),
      ...
      flat_person_fee: (order_data["flat_person_fee"] || 0.0) |> Float.round(2),
      home_delivery_fee: (order_data["home_delivery_fee"] || 0.0) |> Float.round(2),
